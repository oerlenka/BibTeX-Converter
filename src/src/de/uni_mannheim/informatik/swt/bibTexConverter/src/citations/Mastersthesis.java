 ...
 */
public class Mastersthesis extends Citation {

	public Mastersthesis(int id, String[] valuePairArray) {
		super(id, valuePairArray);
		citationType = "Mastersthesis";
	}
	...
	protected String getFormattedString() {
		...
		format = Settings.MasterthesisFormat;
